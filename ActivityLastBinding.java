...
public final class ActivityLastBinding implements ViewBinding {
  ...
  private ActivityLastBinding(@NonNull RecyclerView rootView, @NonNull RecyclerView cycle2) {
  ...
  public static ActivityLastBinding bind(@NonNull View rootView) {
    ...
    RecyclerView cycle2 = (RecyclerView) rootView;

    return new ActivityLastBinding((RecyclerView) rootView, cycle2);
  }
}
