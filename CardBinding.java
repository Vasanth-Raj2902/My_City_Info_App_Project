...
public final class CardBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView Imagestarts;
  ...
  private CardBinding(@NonNull CardView rootView, @NonNull ImageView Imagestarts,
      @NonNull CardView cardview, @NonNull TextView states) {
    this.rootView = rootView;
    this.Imagestarts = Imagestarts;
  ...
  public static CardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.Imagestarts;
      ImageView Imagestarts = ViewBindings.findChildViewById(rootView, id);
      if (Imagestarts == null) {
        break missingId;
      }
      ...
      id = R.id.states;
      TextView states = ViewBindings.findChildViewById(rootView, id);
      if (states == null) {
        break missingId;
      }

      return new CardBinding((CardView) rootView, Imagestarts, cardview, states);
    }
